...
function makeTransaction(quantity, pricePerDroid, customerCredits) {
  let totaPrice = quantity * pricePerDroid;
  if (customerCredits < totaPrice) {
    console.log("Insufficient funds!");
  } else {
    console.log(`"You ordered ${quantity} droids worth ${totaPrice} credits!"`);
  }
  return console.log(makeTransaction(5, 3000, 23000)); // "You ordered 5 droids worth 15000 credits!"
}
